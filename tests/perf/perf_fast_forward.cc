...
public:
    ...
    uint64_t writes_blocked() const { return after.io.fstream_writes_blocked - before.io.fstream_writes_blocked; }
...
public:
    ...
    generator_fn make_generator(schema_ptr s, const table_config& cfg) override {
        ...
        return [this, s, ck = 0, n_ck = n_rows(cfg), value, pk] () mutable -> stdx::optional<mutation> {
            if (ck == n_ck) {
                return stdx::nullopt;
            }
