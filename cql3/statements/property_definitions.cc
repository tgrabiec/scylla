...
///
property_definitions::map_type to_flat_map(const property_definitions::extended_map_type& in) {
...
property_definitions::extended_map_type from_flat_map(const property_definitions::map_type& in) {
