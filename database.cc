...
future<utils::UUID> update_schema_version(service::storage_service& ss, distributed<service::storage_proxy>& proxy)
{
    return db::schema_tables::calculate_schema_digest(ss, proxy).then([&proxy] (utils::UUID uuid) {
...
future<> update_schema_version_and_announce(service::storage_service& ss, distributed<service::storage_proxy>& proxy)
{
    return update_schema_version(ss, proxy).then([] (utils::UUID uuid) {
