...
The options above mean that the replication factor for datacenter `dc1` is 3, and for datacenter `dc2` it is 2,
with replicas placed on racks `rack1` and `rack2`.
