...
public:
    ...
    future<std::unordered_map<dht::token_range, inet_address_vector_replica_set>> get_range_to_address_map(locator::token_effective_replication_map_ptr erm) const;

    future<std::unordered_map<dht::token_range, inet_address_vector_replica_set>> get_range_to_address_map(locator::token_effective_replication_map_ptr erm,
...
private:
     ...
     */
    future<std::unordered_multimap<inet_address, dht::token_range>> get_new_source_ranges(locator::token_effective_replication_map_ptr erm, const dht::token_range_vector& ranges) const;
    ...
    future<std::unordered_multimap<dht::token_range, inet_address>> get_changed_ranges_for_leaving(locator::token_effective_replication_map_ptr erm, inet_address endpoint);
...
public:
     ...
     */
    dht::token_range_vector get_ranges_for_endpoint(const locator::token_effective_replication_map_ptr& erm, const gms::inet_address& ep) const;
