...
public:
     ...
     */
    virtual inet_address_vector_replica_set get_natural_endpoints(const token&, const token_effective_replication_map&) const override;
    virtual stop_iteration for_each_natural_endpoint_until(const token&, const token_effective_replication_map&, const noncopyable_function<stop_iteration(const inet_address&)>& func) const override;
};
}
