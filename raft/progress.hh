...
public:
    ...
    void set_configuration(const std::unordered_set<server_address>& servers, index_t next_idx);
...
class votes {
    ...
    size_t _granted = 1;
public:
    void set_configuration(const std::unordered_set<server_address>& servers) {
