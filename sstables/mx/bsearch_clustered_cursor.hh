...
///
/// Designed for multiple user. All methods may be invoked concurrently.
///
...
public:
    ...
    ~cached_promoted_index_reader() {
        _metrics.block_count -= _cache._blocks.size();
        _metrics.evictions += _cache._blocks.size();
        for (auto&& b : _cache._blocks) {
