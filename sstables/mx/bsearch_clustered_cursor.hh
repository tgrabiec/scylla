...
public:
    ...
    void invalidate_prior(promoted_index_block_ptr block, tracing::trace_state_ptr trace_state) {
      with_allocator(_cache_region.allocator(), [&] {
        _cached_file.invalidate_at_most_front(_promoted_index_start + block->offset, trace_state);
        _cached_file.invalidate_at_most(_promoted_index_start + get_offset_entry_pos(0), get_offset_entry_pos(block->index), trace_state);
