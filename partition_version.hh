...
public:
    ...
    partition_snapshot_ptr& operator=(partition_snapshot_ptr&& other) noexcept = default;
    partition_snapshot_ptr& operator=(const partition_snapshot_ptr& other) noexcept = default;
