...
void table::set_metrics() {
    ...
    if (_config.enable_metrics_reporting) {
        _metrics.add_group("column_family", {
                ...
                ms::make_counter("memtable_rows_dropped_by_tombstones", _stats.memtable_app_stats.rows_dropped_by_tombstones, ms::description("Number of rows scanned during write of a tombstone for the purpose of compaction in memtables"))(cf)(ks),
                ms::make_counter("memtable_rows_compacted_with_tombstones", _stats.memtable_app_stats.rows_compacted_with_tombstones, ms::description("Number of rows dropped in memtables by a tombstone write"))(cf)(ks),
