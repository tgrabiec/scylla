...
///
///    6) partition_end is never emitted, the user needs to call next_partition()
...
flat_mutation_reader make_flat_mutation_reader(flat_mutation_reader_v2);

// Adapts a v1 reader to v2 reader
flat_mutation_reader_v2 make_flat_mutation_reader_v2(flat_mutation_reader);
