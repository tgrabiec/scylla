...
flat_mutation_reader make_flat_mutation_reader(flat_mutation_reader_v2 r) {
    class transforming_reader : public flat_mutation_reader::impl {
        ...
        std::optional<position_in_partition> _tombstone_start;
...
flat_mutation_reader_v2 make_flat_mutation_reader_v2(flat_mutation_reader r) {
