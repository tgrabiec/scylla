...
public:
    ...
    // Can be called only when cursor is valid and pointing at a row, and position().is_clustering_row().
    ...
    rows_entry& ensure_entry_in_latest() {
        ...
        if (is_in_latest_version()) {
            ...
            // FIXME: Avoid the copy by supporting incomplete clustering row entries.
