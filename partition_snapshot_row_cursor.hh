...
class partition_snapshot_row_cursor final {
    ...
    small_vector<position_in_version, 2> _heap;
    small_vector<mutation_partition::rows_type::iterator, 2> _iterators;
    small_vector<position_in_version, 2> _current_row;
    bool _continuous;
    bool _dummy;
