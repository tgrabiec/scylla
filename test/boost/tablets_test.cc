...
SEASTAR_THREAD_TEST_CASE(test_creating_lots_of_tables_doesnt_overflow_metadata) {
    ...
    do_with_cql_env_thread([] (auto& e) {
        ...
        // 10 tablet/shard (initial_scale) * 16 shards = 160 tablets, rounded up to 256.
