    ...
    void lock_topology() {
        ...
        while (true) {
            ...
            service::group0_command g0_cmd = client.prepare_command<service::topology_change>(
                    {service::topology_mutation_builder(guard.write_timestamp())
...
public:
                              ...
                              std::optional<endpoint_dc_rack> rack_override = {})
    {
        ...
        while (true) {
            ...
            service::group0_command g0_cmd = client.prepare_command<service::topology_change>({builder.build()}, guard,
