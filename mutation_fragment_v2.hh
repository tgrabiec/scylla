...
//
// The stream may end with an active tombstone.
...
public:
    ...
    bool equal(const schema& s, const range_tombstone_change& other) const {
        ...
        return eq(_pos, other._pos) && _tomb == other._tomb;
    }
...
public:
    ...
    void mutate_as_range_tombstone(const schema& s, std::invocable<range_tombstone_change&> auto&& fn) {
